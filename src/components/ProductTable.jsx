...
const ProductTable = ({ products, itemsPerPage, setItemsPerPage, currentPage, setCurrentPage, sortOrder, setSortOrder, sortDirection, setSortDirection, fetchProducts }) => {
  ...
  const [addProductData, setAddProductData] = useState({}); // New product data state
  ...
  const handleAddSubmit = async () => {
    ...
    try {
      ...
      setAddProductData({}); // Reset the add product data
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                ...
                <input type="text" name="name" value={editProductData.name || ''} onChange={handleEditChange} className="mt-1 block w-full border-btnbg border-2 px-1 rounded-md shadow-sm placeholder:text-right text-right bg-white text-black " />
              </div>
              <div className="mb-4">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                ...
                <input type="number" name="price" value={editProductData.price || ''} onChange={handleEditChange} className="mt-1 block w-full border-btnbg border-2 px-1 rounded-md shadow-sm placeholder:text-right text-right bg-white text-black " />
              </div>
              <div className="mb-4">
                <label className="flex justify-between text-sm font-medium text-gray-700"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
  <path strokeLinecap="round" strokeLinejoin="round" d="m20.25 7.5-.625 10.632a2.25 2.25 0 0 1-2.247 2.118H6.622a2.25 2.25 0 0 1-2.247-2.118L3.75 7.5M10 11.25h4M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125Z" />
</svg>تعداد</label>
                <input type="number" name="quantity" value={editProductData.quantity || ''} onChange={handleEditChange} className="mt-1 block w-full border-btnbg border-2 px-1 rounded-md shadow-sm placeholder:text-right text-right bg-white text-black " />
              </div>
              <div className="mb-4">
                <label className="flex justify-between text-sm font-medium text-gray-700"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 6.75h12M8.25 12h12m-12 5.25h12M3.75 6.75h.007v.008H3.75V6.75Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0ZM3.75 12h.007v.008H3.75V12Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm-.375 5.25h.007v.008H3.75v-.008Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
                ...
                <select name="subcategory" value={editProductData.subcategory || ''} onChange={handleEditChange} className="mt-1 block w-full border-btnbg border-2 px-1 rounded-md shadow-sm placeholder:text-right text-right bg-white text-black ">
              ...
              <div className="mb-4">
                ...
                <textarea name="description" value={editProductData.description || ''} onChange={handleEditChange} className="mt-1 block w-full border-btnbg border-2 px-1 rounded-md shadow-sm placeholder:text-right text-right bg-white text-black"></textarea>
              </div>
...
برند</label>
              ...
              <div className="mb-2 col-span-3  text-sm font-medium text-gray-700 text-right">
                <label className="block font-medium text-gray-700 text-right mt-3 mr-2 text-lg">توضیحات</label>
                  <div className=''>
                       <Editor name="description" value={addProductData.description || ''} onChange={handleAddChange}
                              apiKey='3rnzjersg458aiz9zzjwaisozacbo42y5qowi1716vqmzja9'
                              init={{
                                plugins: [
